...
for POP in EAS SAS AFR; do
    ...
    echo "  âœ“ ${POP} complete: ${POP_SAMPLES} samples Ã— ${POP_SNPS} SNPs"
    ...
    echo "  âœ“ Frequencies written to freq_${POP}.frq"
...
plink --bfile "${BASEDIR}/merged_all_chrs" \
      ...
      --out "freq_UZB" \
      --silent
echo "  âœ“ UZB frequencies written"
...
plink --bfile "${BASEDIR}/merged_all_chrs" \
      ...
      --out "freq_EUR" \
      --silent
echo "  âœ“ EUR frequencies written"
...
for POP in EAS SAS AFR; do
    ...
    echo "  âœ“ UZB vs ${POP} Fst computed"
...
echo "  âœ“ EUR vs EAS Fst computed"
